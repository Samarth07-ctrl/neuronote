            ...
            <main className="flex-1 flex flex-col items-center px-6 pt-10 pb-20">
                ...
                <div className="max-w-4xl mx-auto text-center w-full">
                    ...
                    <section id="about" className="mt-24 max-w-4xl mx-auto text-center md:text-left">
                        ...
                        >
                            <h2 className="text-3xl md:text-4xl font-semibold text-foreground mb-6 text-center">About NeuroNote</h2>
                            <p className="text-muted-foreground text-lg leading-relaxed">
                                NeuroNote blends compassionate design with trusted mental health practices. We bring together AI-guided reflections, supportive peers, and professional mentors so you can build lasting mental wellness habits at your own pace.
                            </p>
                            ...
                            <div className="grid md:grid-cols-2 gap-10 items-center">
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-lg leading-relaxed mt-4">
                                        Have questions about NeuroNote, want to partner with us, or need help getting started? Our team is a message away.
                                    </p>
                ...
                <div className="max-w-7xl mx-auto px-8 py-12">
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10">
                        <div className="space-y-3 max-w-sm">
                            <span className="text-4xl jersey-15-regular text-foreground block">NeuroNote</span>
                    ...
                    <div className="mt-10 border-t border-border/40 pt-6 flex flex-col md:flex-row gap-4 md:items-center md:justify-between text-xs text-muted-foreground">
                        <p>© {new Date().getFullYear()} NeuroNote. All rights reserved.</p>
