...
const Diary = () => {
    ...
    const [activeTab, setActiveTab] = useState("write"); // 'write', 'read', or 'analytics'
    ...
    const saveEntry = async () => {
        ...
        try {
            ...
            await addDoc(collection(db, "diary"), {
                ...
                // Daily Check-in Data (Phase 1)
                sleepHours: sleepHours,
                sleepQuality: sleepQuality,
                lifeBalance: lifeBalance
            });
            setEntry("");
            // Reset check-in values to defaults
            setSleepHours(7);
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-8">
                ...
                <div className="flex justify-center mb-8 gap-4">
                    ...
                    <button
                        ...
                        className={`px-8 py-3 rounded-full text-lg font-medium transition-all duration-300 ${activeTab === "analytics"
                                ? "bg-green-900 text-white shadow-lg scale-105"
                                : "bg-white/80 backdrop-blur-sm text-gray-700 hover:bg-white border border-gray-200"
                            }`}
                    >
                ...
                {activeTab === "write" && (
                    <div className="max-w-3xl mx-auto">
                        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-gray-200/50 p-8 min-h-[600px] flex flex-col relative overflow-hidden">
                            ...
                            <div className="mb-6 bg-gradient-to-br from-green-50/80 to-emerald-50/80 rounded-2xl p-6 border border-green-200/50">
                                ...
                                <div className="mb-5">
                                    <label className="block text-sm font-medium text-gray-700 mb-2">
                                        Sleep Hours: <span className="text-green-700 font-semibold">{sleepHours}h</span>
                                    </label>
                                    <input
                                        type="range"
                                        min="0"
                                            ...
                                            <button
                                                ...
                                                className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${
                                                    sleepQuality === quality
                                                        ...
                                                        : "bg-white/80 text-gray-700 hover:bg-green-50 border border-gray-200"
                                                }`}
                                            >
                                                {quality}
                                            </button>
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-3">Life Balance (Rate 1-10)</label>
                                    <div className="space-y-4">
                                        {Object.keys(lifeBalance).map((area) => (
                                            <div key={area}>
                                                <div className="flex justify-between items-center mb-1">
                                                    <span className="text-sm text-gray-700">{area}</span>
                                                    <span className="text-sm font-semibold text-green-700">{lifeBalance[area]}/10</span>
                                                </div>
                                                <input
                                                    type="range"
                                                    min="1"
                                                    max="10"
                                                    value={lifeBalance[area]}
                                                    onChange={(e) => setLifeBalance({ ...lifeBalance, [area]: parseInt(e.target.value) })}
                                                    className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-green-700"
                                                />
                                            </div>
                                        ))}
